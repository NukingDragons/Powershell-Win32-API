...
class WSAPROTOCOL_INFOA : BaseWin32Class
{
	...
	[IntPtr] ToUnmanaged()
	{
		...
		if ($this.szProtocol)
		{
			...
			$szProtocolAnsi = [System.Runtime.InteropServices.Marshal]::StringToHGlobalAnsi($szProtocolStr)
			[System.Runtime.InteropServices.Marshal]::Copy($szProtocolAnsi, $szAnsis, 0, $szProtocolStr.Length)
			[System.Runtime.InteropServices.Marshal]::FreeHGlobal($szProtocolAnsi)
		}
	...
	[WSAPROTOCOL_INFOA] FromUnmanaged([IntPtr] $Unmanaged)
	{
		...
		$Offset += $Data32_4.Length * 4
		[System.Runtime.InteropServices.Marshal]::Copy($Unmanaged.ToInt64() + $Offset, $szAnsis, 0, $szAnsis.Length)
		...
		$szProtocolAnsi = [System.Runtime.InteropServices.Marshal]::AllocHGlobal(256)
		[System.Runtime.InteropServices.Marshal]::Copy($szAnsis, 0, $szProtocolAnsi, 255)
		$this.szProtocol = [System.Runtime.InteropServices.Marshal]::PtrToStringAnsi($szProtocolAnsi)
		[System.Runtime.InteropServices.Marshal]::FreeHGlobal($szProtocolAnsi)
